  ...
  class extends HTMLElement {
        ...
        myDropzone.on("thumbnail", function (file) {
          ...
          if (imageDataURL != undefined) {
            ...
            labelPet.addEventListener("click", () => {
              // const imgCont = document.querySelector(".pet-picture-container");
              // const div = document.querySelector(".pet-text");
    ...
    render() {
      ...
      <div class="content-cont">
        <h3 class="title">Reportar mascota perdida</h3>
        <form class="form-cont dropzone">
          <label class="label"
            >NOMBRE<input class="input" type="text" name="fullname"
          /></label>

          <p class="pet-text">Arrastra o clickea en el rectangulo de abajo para agregar una imagen de tu mascota.</p>
